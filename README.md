...
## 📋 Description
Jarvis est un outil web pour optimiser le placement des Cogs dans Legend of Idleon (Monde 3).
Il utilise un algorithme génétique pour maximiser taux de construction, XP, et vitesse de flags.
...
### Version en ligne
https://latury.github.io/Jarvis-Optimisateur-Construction/
...
## 🤝 Contribution
Vous êtes les bienvenus à contribuer !

1. Forkez le projet
2. Créez une branche de fonctionnalité `feature/nom-fonctionnalite`
...
## 🙏 Remerciements
- Projet Cogtimizer par Monoblos
